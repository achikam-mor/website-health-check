...
export class VPNBookAccessor {
    ...
    async searchWebsite(url) {
        ...
        try {
            ...
            const goButton = await this.page.locator('button:has-text("Go"), button:has-text("GO"), button[type="submit"], input[type="submit"], button:has-text("Browse"), button:has-text("Surf")').first();
 ...
 */
export async function runVPNBookAccess(targetUrl = 'www.stockscanner.net') {
