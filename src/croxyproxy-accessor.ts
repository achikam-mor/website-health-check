...
export class CroxyProxyAccessor {
   ...
   */
  async scroll(distance: number = 500): Promise<void> {
    if (!this.page) {
      throw new Error('Browser not initialized.');
    }
 ...
 */
export async function runCroxyProxyAccess(targetUrl: string = 'www.stockscanner.net'): Promise<CroxyProxyAccessor> {
